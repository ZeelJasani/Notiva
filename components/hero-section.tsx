...
//                                     A minimal block based editor built for developers
//                                 </TextEffect>
...
//                                         </Link>
//                                     </Button> */}
//                                         <button className="btn-primary" style={{ padding: '1rem 2rem', fontSize: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
